...
- [x] Création du squelette du code général routeur et MVC
- [x] Création des dossiers racine (src, views, etc.)  
- [x] Création des fichiers de structure (sprint 1, sprint 2, sprint 3)
